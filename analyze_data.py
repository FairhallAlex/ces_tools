...
def loop_functions():
    # Loop through all datafiles in current folder, plot raw data.
    for i in range(len(files)):
        ...
        b,c = butter(2, 1200/nyq) #2500 is default
        ...
        # Subplot 1, plot globally normalized data
        ...
        #Subplot 2, plot labelled peaks and thresholds
...
# Lets pretend we have all our data already
